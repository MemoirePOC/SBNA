...
st.set_page_config(page_title="Sécurité ATS — PoC Niamey", page_icon="🛡️", layout="wide")
...
DATASETS_ID1 = {
    ...
    "TMA_GENERALE (08/04/26)": data.df_tma_general3_net,
    "TMA_GENERALE (09/04/26)": data.df_tma_general4_net,
